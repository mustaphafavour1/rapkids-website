...
export const metadata: Metadata = {
  title: "Rules",
  description:
    "The official rules of the RapKids TypeMaster Championship: eligibility, age group, entry, billing, fair play, prizes, the Grand Final, and child-protection commitments.",
};
